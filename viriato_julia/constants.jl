...
const nu_ei = const_data["diffusion"]["nu_ei"]
const res = const_data["diffusion"]["res"]
const niu = const_data["diffusion"]["niu"]
const hyper_coef = 0.0
const hyper_coef_g = 0.0
const hyperm_coef = 0.0
...
const hyper_fixed = const_data["diffusion"]["hyper_fixed"]
const hyper_order = const_data["diffusion"]["hyper_order"]
const hyper_order_g = const_data["diffusion"]["hyper_order_g"]
const hyper_morder = const_data["diffusion"]["hyper_morder"]
const hyper_eta = const_data["diffusion"]["hyper_eta"]
const hyper_nu = const_data["diffusion"]["hyper_nu"]
const hyper_nu_g = const_data["diffusion"]["hyper_nu_g"]
const hyper_colls_fixed = const_data["diffusion"]["hyper_colls_fixed"]
const hyper_colls = const_data["diffusion"]["hyper_colls"]
